...
# CHARACTER_SHOW_DELAY_REGULAR=0.0
...
def print_immigrant_hello(immigrant_name):
    print_immigrant(immigrant_name, "hello. My name is foo")
...
def main(stdscr):
    ...
    for i in range(10):
        ...
        # Provide options
        # ===============
        immigration_choice = read_immigration()
